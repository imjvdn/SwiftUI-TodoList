//: Test Runner for SwiftUI Todo List App
import SwiftUI
import PlaygroundSupport

// Import models and classes from main app
// We need to duplicate the model code here since playgrounds don't support importing from other files
...
// Display test results in the playground
struct TestResultView: View {
    var body: some View {
        VStack(spacing: 20) {
            Text("SwiftUI Todo List - Test Results")
                .font(.largeTitle)
                .fontWeight(.bold)
            ...
            VStack(alignment: .leading, spacing: 10) {
                Text("✅ TodoItem Model Tests")
                Text("✅ TodoStore Functionality Tests")
                Text("✅ ColorTheme Tests")
                Text("✅ Priority Enum Tests")
                Text("✅ Overdue Functionality Tests")
                Text("✅ Codable Implementation Tests")
            }
            .padding()
            .background(
            ...
            Text("Your Todo List app is working correctly!")
                .padding(.top)
        }
        .padding()
    }
...
// Show test results in the playground
PlaygroundPage.current.setLiveView(TestResultView().frame(width: 400, height: 500))
